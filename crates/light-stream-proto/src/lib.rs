...
pub use convert::{
    ...
    capabilities_to_wire, checkpoint_cas_from_wire, checkpoint_cas_to_wire, checkpoint_from_wire,
    checkpoint_key_from_wire, checkpoint_key_to_wire, checkpoint_to_wire,
    compare_and_set_checkpoint_from_wire, create_bookmark_from_wire,
